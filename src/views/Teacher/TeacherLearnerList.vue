<template>
            ...
            <template #item-action="{userDetails }">
                <div class="flex">
                    <router-link :to="'/student_grade/'+userDetails._id+'/'+userDetails.classId">
                        ...
                        <PlusIcon class="stroke-blue-600 mr-2 h-5 w-5"></PlusIcon>
                        <span class="text-blue-600">Grades</span>
                    </div>

                        <!-- <PlusCircleIcon class="stroke-blue-600 mr-2 h-5 w-5">Add Scores</PlusCircleIcon> -->
                    </router-link>
    <!-- 
    ...
    export default{
        components:{DocumentArrowDownIcon, UserPlusIcon, PlusIcon, EyeSlashIcon, PencilIcon, EyeIcon, ArchiveBoxArrowDownIcon, Cog6ToothIcon, PencilSquareIcon, PlusCircleIcon
            },
