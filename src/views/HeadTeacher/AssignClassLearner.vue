         ...
         <h1 class="flex items-center text-xl font-semibold px-4 pt-6 uppercase">
          ...
          <div class="w-full lg:w-12/12 px-4 pt-6">
           ...
           <div class="relative w-full mb-3 mt-6 flex justify-end px-4">
              ...
              <button @click="assign_student_class" :disabled="loading" class="flex justify-center items-center rounded-lg 
    ...
    setup(){
        ...
        const assign_student_class = ()=>{
                ...
                if(!classId.value){
                    ...
                    loading.value = true
                    axios
                      .put(`${config.API_URL}/assign_student_class/${route.params.id}`,
                      {
        ...
        return{
            is_loading, read_list_classes, class_list, loading, classId,
