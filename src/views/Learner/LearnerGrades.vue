    ...
    setup(){
                ...
                const getTeacherName = (item) => {
                    ...
                    const exportToPDF = ()=>{
                        ...
                        doc.save('Learner grades report.pdf');
                }
        ...
        return{
             learnerList, searchField, searchValue, institutionId, institutionName, 
             userId, learnerId, is_loading, get_list_subjects_class_learner, getTeacherName, headers,
             exportToPDF
        }
